    ...
    if (M == 64 && N == 64) {
        ...
        for (int i = 0; i < 64; i += 8) {
            for (int j = 0; j < 64; j += 8) {
                ...
                for(int l = j; l < j + 4; l++) {
                    v1 = B[l][i+4], v2 = B[l][i+5], v3 = B[l][i+6], v4 = B[l][i+7];
                    v5 = A[i+4][l], v6 = A[i+5][l], v7 = A[i+6][l], v8 = A[i+7][l];

                    B[l][i+4] = v5, B[l][i+5] = v6, B[l][i+6] = v7, B[l][i+7] = v8;
                    B[l+4][i] = v1, B[l+4][i+1] = v2, B[l+4][i+2] = v3, B[l+4][i+3] = v4;
                }
